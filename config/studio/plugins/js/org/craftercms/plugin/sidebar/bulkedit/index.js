...
var API_UNLOCK_CONTENT = '/studio/api/1/services/api/1/content/unlock-content.json';
var API_SANDBOX_ITEM_BY_PATH = '/studio/api/2/content/sandbox_items_by_path';
var StudioAPI = {
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              url = "".concat(StudioAPI.origin()).concat(API_UNLOCK_CONTENT, "?site=").concat(StudioAPI.siteId(), "&path=").concat(path);
              _context7.next = 3;
              return HttpHelper.get(url);

            case 3:
              res = _context7.sent;
              return _context7.abrupt("return", res.status === 200);
      ...
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              url = "".concat(StudioAPI.origin()).concat(API_SANDBOX_ITEM_BY_PATH);
              body = {
            ...
            case 4:
              ...
              return _context8.abrupt("return", res.response.items[0]);
...
const _excluded$O = ["BackdropComponent", "BackdropProps", "children", "classes", "className", "closeAfterTransition", "component", "components", "componentsProps", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestor